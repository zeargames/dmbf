    ...
    for _suci_salsabila_ in _cici_.split(" "):
        if len(_suci_salsabila_)<3:
            ...
            if len(_suci_salsabila_)==3 or len(_suci_salsabila_)==4 or len(_suci_salsabila_)==5:
                ...
                _dapunta_.append(_suci_salsabila_+"01")
                _dapunta_.append(_suci_salsabila_+"02")
                _dapunta_.append(_suci_salsabila_+"03")
                _dapunta_.append(_suci_salsabila_+"04")
                _dapunta_.append(_suci_salsabila_+"05")
                _dapunta_.append(_suci_salsabila_+"06")
                _dapunta_.append(_suci_salsabila_+"07")
                _dapunta_.append(_suci_salsabila_+"1")
                _dapunta_.append(_suci_salsabila_+"2")
                _dapunta_.append(_suci_salsabila_+"3")
                _dapunta_.append(_suci_salsabila_+"4")
                _dapunta_.append(_suci_salsabila_+"5")
                _dapunta_.append(_suci_salsabila_+"6")
                _dapunta_.append(_suci_salsabila_+"7")
            else:
